    ...
    return (
      <div className="Biography Parrafo">
        ...
        <ul className="Curiosidades">
          <li>A lo largo de gran parte de su carrera, Hopper era muy demandada como oradora en eventos relacionados con la <a href="#">informática</a>. Era conocida por su animado e irreverente estilo de oratoria, así como por sus historias de guerra.</li><br/>
