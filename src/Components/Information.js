    ...
    return (
      <div className="Information">
        ...
        <div className="Img-Info">
          <img src={Univac} className="Info-img" alt="Univac" />
          <span>Grace Hopper a la estación de control de la UNIVAC I alrededor de 1960</span>
        </div>
        <div className="Img-Info">
          <img src={Bug} className="Info-img" alt="Univac" />
          <span>Bug encontrado en la Mark II.</span>
        </div>
      </div>
    );
  }
